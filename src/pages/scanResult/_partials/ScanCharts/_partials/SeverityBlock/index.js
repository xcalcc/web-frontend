...
const SeverityBlock = props => {
    ...
    return <Container fluid className="risk-severity-block noPadding">
        <Row noGutters>
            <Col xs={4} className="align-content-end">
                <SeverityDoughnut
                    ...
                    levelText={i18n.t('common.severity.high')}
            ...
            <Col xs={4} className="align-content-end">
                <SeverityDoughnut
                    ...
                    issues={mediumIssues}
                    totalIssues={totalIssues}
                    levelText={i18n.t('common.severity.medium')}
            ...
            <Col xs={4} className="align-content-end">
                <SeverityDoughnut
                    ...
                    issues={lowIssues}
                    totalIssues={totalIssues}
                    levelText={i18n.t('common.severity.low')}
