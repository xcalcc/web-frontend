...
import MeterBlock from "./_meterBlock";
...
const ProjectSummaryPage = (props) => {
    ...
    const charts = (
        <Row noGutters className="charts">
            <Col className={`project-risk block`} md={3}>
                <MeterBlock criticality={projectSummaryData.criticality}/>
            </Col>
            ...
            <Col className={`risk-chart block`} md={5}>
                <SeverityBlock
                    riskDataMap={{
                        high: 0,
                        medium: 0,
            ...
            <Col className="assigned-defects block" md={2}>
                <AssignmentsBlock
                    assigned={
                        projectSummaryData.defectsAssigned &&
                        projectSummaryData.defectsAssigned.count
                    }
                    assignedPercentage={
                        projectSummaryData.defectsAssigned &&
                        projectSummaryData.defectsAssigned.percentage
                    }
                />
            </Col>
        </Row>
    ...
    return (
        ...
        >
            ...
            {((filterConditions.ruleCodes && filterConditions.ruleCodes.length) || filterConditions.searchValue || filterConditions.ruleSetAndStandardNames) && (
                <FilterCondition
                    ...
                    ruleSetAndStandardNames={filterConditions.ruleSetAndStandardNames}
                />
            )}
            <hr/>
            {charts}
            ...
            <DefectsByRiskLevelTableBlock
                locale={locale}
                criticalityGroups={projectSummaryData.groupByCriticalityCertainty}
            />
        </Container>
    );
};
