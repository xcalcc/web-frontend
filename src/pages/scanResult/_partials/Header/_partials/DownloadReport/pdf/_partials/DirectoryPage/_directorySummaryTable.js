...
const DirectorySummaryTable = props => {
    ...
    const headRows = [
        ...
        {field: 'risk-high', label: getRiskTableHeader(i18n.t('pages.scan-result.pdf.table.high'), 'high'), className: 'table-header risk-high'},
        {field: 'risk-medium', label: getRiskTableHeader(i18n.t('pages.scan-result.pdf.table.medium'), 'medium'), className: 'table-header risk-medium'},
        {field: 'risk-low', label: getRiskTableHeader(i18n.t('pages.scan-result.pdf.table.low'), 'low'), className: 'table-header risk-low'},
    ];

				
    return <div className={`${locale} directory-summary-table-pdf`}>
