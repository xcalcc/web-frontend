...
import MultipleSelectionTips from "./MultipleSelectionTips";
import './style.scss';
...
const IssueTable = props => {
    ...
    const getTableHead = () => {
        let headRows = [
            ...
            {field: 'variableName', label: i18n.t('pages.scan-result.issue-table.variable'), isSort: false},
            ...
            {field: '-', label: i18n.t('pages.scan-result.issue-table.validation'), isSort: false},
        ];
    ...
    const getValidationColumn = issue => {
        ...
        return <DropDownWithTitle 
            menuGroups={[
                ...
                {
                    menus: [{
                        label: i18n.t('pages.scan-result.custom-filter'),
                        value: '',
                        icon: '',
