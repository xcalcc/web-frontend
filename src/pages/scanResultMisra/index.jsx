...
const ScanResult = props => {
    ...
    useEffect(() => {
        (async () => {
            ...
            const scanSummaryFilter = {
                ruleSets: enums.MISRA_RULE_SETS,
            ...
            if(scanTaskId) {
                ...
                scanSummary = await dispatch(actions.fetchScanSummaryByProjectUuid(
                    project_uuid,
                    {
                        ...scanSummaryFilter,
                        ruleSets: enums.MISRA_RULE_SETS
    ...
    return <Container fluid className="scan-result-wrap scan-result-wrap-misra">
        {isLoading && <Loader />}
        <Row>
            <Col>
                <Header 
...

        {
            ...
            <Switch>
                <Route exact path="/misra/project/:projectKey">
                    <GeneralPage
                        projectKey={projectKey}
                        projectUuid={projectUuid}
                        scanTaskId={scanTaskId}
